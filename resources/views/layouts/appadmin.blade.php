                ...
                <div class="scrollbar-sidebar" style="overflow: auto;">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <!-- Caches -->
                            <li class="app-sidebar__heading">Caches</li>
                            <li>
                                <a href="/clear-cache">
                                    <i class="metismenu-icon lnr-magic-wand"></i>clear Caches
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/clear-views') }}">
                                    <i class="metismenu-icon pe-7s-glasses"></i>clear viewes
                                </a>
                            </li>

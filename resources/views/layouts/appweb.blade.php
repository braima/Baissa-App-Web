                ...
                <div class="scrollbar-sidebar" style="overflow: auto;">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="/crm/commandes" class="<?php if($page == 'commandes'){echo 'mm-active';} ?>">
                                    Commandes
                                </a>
                            </li>
                            <li>
                                <a href="/crm/commandesvalid" class="<?php if($page == 'commandesvalid'){echo 'mm-active';} ?>">
                                    validée
                                </a>
                            </li>
                            <li>
                                <a href="/crm/commandescanceled" class="<?php if($page == 'commandescanceled'){echo 'mm-active';} ?>">
                                    Annulé
                                </a>
                            </li>
                            ...
                            <li class="app-sidebar__heading">
                                <a href="/crm/categories" class="<?php if($page == 'categories'){echo 'mm-active';} ?> pl-3">
                                    Catégories
                                </a>
                            </li>
                            <!-- Produits -->
                            <li class="app-sidebar__heading">
                                <a href="/crm/allproducts" class="<?php if($page == 'produits'){echo 'mm-active';} ?> pl-3">
                                    Produits
                                </a>
                            </li>
                            ...
                            <!-- Tombola -->
                            <li class="app-sidebar__heading">
                                <a href="/crm/tombola" class="<?php if($page == 'tombola'){echo 'mm-active';} ?> pl-3">
                                    Tombola
                                </a>
                            </li>
                            ...
                            <!-- Contact -->
                            <li class="app-sidebar__heading">
                                <a href="/crm/clients" class="<?php if($page == 'clients'){echo 'mm-active';} ?> pl-3">
                                    Clients
                                </a>
                            </li>

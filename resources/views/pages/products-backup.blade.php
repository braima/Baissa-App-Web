            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 text-center p-0 mt-3 mb-2">
                    ...
                    <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="form" action="submitorder" method="POST" class="was-validated">
                        ...
                        {{ csrf_field() }}
                            ...
                            <fieldset>
                                ...
                                <input type="button" name="next-step" class="next-step next-step1" value="Étape suivante" />
                            ...
                            <fieldset>
                                ...
                                <div class="row formfields">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="billing-info mb-20">
                                            ...
                                            <input type="text" class="form-control" id="clientname" name="clientname" placeholder="Nom complet" required>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="billing-info mb-20">
                                            ...
                                            <input class="form-control" type="tel" id="clientphone" name="clientphone" pattern="^\d{2}\d{2}\d{2}\d{2}\d{2}$" onkeypress="return onlyNumbers(event)" placeholder="06 1234 5678" maxlength="10" required >
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="billing-info mb-20">
                                            ...
                                            <input class="form-control" id="clientadress" name="clientadress" placeholder="Adresse" type="text" required >
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="billing-info mb-20">
                                            ...
                                            <input class="form-control" type="text" id="clientville" name="clientville" placeholder="Ville" required >
                                ...
                                <input type="submit" id="submitorder" name="next-step" class="next-step lancercmd" value="Lancer ma commande" disabled="disabled"/>
                                <input type="button" name="previous-step" class="previous-step  btn btn-secondary" value="Étape précédente" />

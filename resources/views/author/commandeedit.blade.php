                          ...
                          <table id="example" class="table table-hover table-striped table-bordered w-100" >
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$produit->label}}</td>
                                <td>
                                  <form action="{{ url('/user/commandeedit/' .$commande->id . '/addpdtocmd/' .$produit->id) }}" method="POST">
                                    @csrf
                      ...
                      <div class="modal fade" id="update{{ $data->id_produit }}" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <form action="{{ '/user/commandeedit/' .$commande->id . '/updateqte/' .$data->id_produit }}" method="POST"  style="display: inline-block;">
                              <div class="modal-body">
                                @csrf
                      ...
                      <div class="modal fade" id="destroy{{ $data->id_produit }}" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                          <div class="modal-content" style="text-align: center;">
                            ...
                            <div class="modal-body">
                              <form action="{{ '/user/commandeedit/' .$commande->id . '/destroy/' .$data->id_produit }}" method="POST"  style="display: inline-block;">
                                @csrf

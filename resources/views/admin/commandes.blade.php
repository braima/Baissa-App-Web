                      ...
                      <tbody>
                        ...
                        <tr>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content" style="text-align: center;">
                                    ...
                                    <div class="modal-body">
                                      <form action="{{'/crm/commandestatus/' . $commande->id}}" method="get"  style="display: inline-block;">
                                        {{ csrf_field() }}
                          ...
                          <td>
                            ...
                            <a class="btn btn-primary" href="{{ url('/crm/commandeedit/'.$commande->id) }}"><i class="fa fa-cog text-light" aria-hidden="true"></i></a>
                            ...
                            <div class="modal fade" id="destroy{{ $commande->id }}" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content" style="text-align: center;">
                                  ...
                                  <div class="modal-body">
                                    <form action="{{'/crm/commandes/destroycmd/' . $commande->id}}" method="POST"  style="display: inline-block;">
                                      {{ csrf_field() }}

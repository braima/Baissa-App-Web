                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info" data-toggle="modal" data-target="#info{{ $seance->id }}" style="color: #fff;"><i class="fa fa-info" aria-hidden="true"></i></a>
                            <div class="modal fade" id="info{{ $seance->id }}" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content" style="text-align: center;">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel" style="width: 100%;">Historique de client : <b>{{ $seance->name  }}</b></h5>
                                  </div>
                                  ...
                                  <table class="table">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">Date d'échéance (GMT +0)</th>
                                        <th scope="col">Description</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                    @foreach ($seanceshistory as $seancehistory)
                                      <tr>
                                        <td>{{ $seance->package  }}</td>
                                        <td>{{ $seancehistory->date  }}</td>
                                        <td>{{ $seancehistory->description  }}</td>
                                      </tr>
                                    @endforeach
                                    </tbody>
                                  </table>
